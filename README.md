...
## فارسی
`V2rayX` یک کلاینت دسکتاپ ویندوز برای مدیریت و اجرای Xray است.
این برنامه مدیریت پروفایل، سابسکریپشن، تست `Ping/Speed`، پراکسی سیستم و Tunnel Mode را در یک رابط ساده ارائه می‌دهد.
